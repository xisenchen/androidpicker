...
public abstract class ConfirmPopup<V extends View> extends BottomPopup<View> {
    ...
    protected int cancelTextColor = Color.GRAY;
    protected int submitTextColor = WheelView.TEXT_COLOR_FOCUS;
    protected int titleTextColor = Color.BLUE;
	...
	protected View makeHeaderView() {
        ...
        cancelButton.setPadding(40,5,20,5);
        ...
        submitButton.setPadding(20,5,40,5);

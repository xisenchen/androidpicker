...
public class WheelView extends ScrollView {
    ...
    public static final int TEXT_COLOR_FOCUS = 0XFF109d59;
    public static final int TEXT_COLOR_NORMAL = 0XFF878787;
    public static final int LINE_COLOR = 0XFF109d59;
     ...
     * Sets offset.
     *
     * @param offset the offset@IntRange(from = 1, to = 4)
     */
    ...
    /**
     * 从0开始计数，所有项包括偏移量@IntRange(from = 0)
     *
     * @param index
     */
